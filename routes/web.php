...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/data-records/{id}/edit-ajax', [DataRecordController::class, 'editAjax'])->name('dataRecords.editAjax');
    Route::put('/data-records/{id}/update-ajax', [DataRecordController::class, 'updateAjax'])->name('dataRecords.updateAjax');
});
